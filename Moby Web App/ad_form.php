											...
											<div id="fuelux-wizard-container">
												<div>
													<ul class="steps">
														...
														<div class="step-pane" id="DIV">
															<span class="step">5</span>
															<span class="title">Add Question</span>
															
														</DIV>
											
														<!--<div class="step-pane" id="myDIV">
															<span class="step">5</span>
															<span class="title">Add Preview</span>
															</div>-->
														</li>
														<li data-step="7" class="<?php echo $final_confirmation; ?>" >
												...
												<div class="step-content pos-rel">
													...
													<div class="step-pane" data-step="2">
														...
														<h4 class="lighter block green"><b>Create Ads</b></h3>
															<button onclick="toggle_div_fun('sectiontohide');myFunction('myDIV');Function('DIV');">Click Bank Details</button> 
