				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header">
							<h1><center><strong>Update Ad:-</strong> <?php echo $saved_ad->ad_name; ?></center></h1>
						</div><!-- /.page-header -->
						<div class="row">
							<div class="col-xs-12">
											...
											<div id="fuelux-wizard-container">
												...
												<div class="step-content pos-rel">
													<div class="step-pane" data-step="1">
														...
														<h4 class="lighter block green"><b>Update Campaign</b></h4>
													...
													<div class="step-pane" data-step="2">
														...
														<h4 class="lighter block green"><b>Update Ad</b></h3>
														<form class="form-horizontal" id="sample-form" method="POST" action="" enctype="multipart/form-data">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-5">
																	<input type="file" name="company_logo" class="width-100" placeholder="Company Logo" accept=".png, .jpeg, .jpg" value="<?php echo $saved_ad->company_logo; ?>" required />
																</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-5">
																	<input type="number" id="coverage_radius" name="coverage_radius" class="width-100" placeholder="Coverage Radius" value="300"  required/>
																</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-5">
																	<input type="number" id="reward_amount" name="reward_amount" class="width-100" placeholder="Reward Amount" value="<?php echo $saved_ad->reward_amount; ?>" required />
																</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-5">
																	<input type="file" name="ads_banner" class="width-100" placeholder="Ads Banner" accept=".png, .jpeg, .jpg" value="<?php echo $saved_ad->ads_banner; ?>" required/>
																</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-5">
																	<div class="input-group">
																		...
																		<input class="form-control" type="text" name="date-range-picker" id="id-date-range-picker-1" value="<?php echo $start_to_end_date; ?>" />
																	</div>
																</div>
																<div class="col-xs-12 col-sm-3 form-text text-muted">Between these dates the audience will be able to interact with the ad.</div>
															</div>
															
															<div class="form-group">
																<label class="col-xs-12 col-sm-3 control-label no-padding-right">Exclusion Days <sup>*</sup></label>
																<div class="col-xs-12 col-sm-5">
																	<select class="select2_multiple form-control" name="exclusion_days[]" multiple>
																		<option value="0" <?php if(in_array("0", $exclusion_days_array)){echo "selected";} ?>>Sunday</option>
																		<option value="1" <?php if(in_array("1", $exclusion_days_array)){echo "selected";} ?>>Monday</option>
																		<option value="2" <?php if(in_array("2", $exclusion_days_array)){echo "selected";} ?>>Tuesday</option>
																		<option value="3" <?php if(in_array("3", $exclusion_days_array)){echo "selected";} ?>>Wednesday</option>
																		<option value="4" <?php if(in_array("4", $exclusion_days_array)){echo "selected";} ?>>Thursday</option>
																		<option value="5" <?php if(in_array("5", $exclusion_days_array)){echo "selected";} ?>>Friday</option>
																		<option value="6" <?php if(in_array("6", $exclusion_days_array)){echo "selected";} ?>>Saturday</option>
																	</select>
																</div>
																...
																<!-- <div class="widget-box">
																	<div class="widget-header widget-header-flat widget-header-small">
																		...
																		<div class="widget-toolbar no-border">
																			<button class="btn btn-minier btn-primary" onclick="takeAudienceType(); ">
																				Refresh
																			</button>
																		</div>
																	</div>
															...
															<div class="control-group">
																...
																<div class="control-group">
																	<label class="line-height-1">
																		...
																		<span class="lbl"><input type="text" name="option3[]" placeholder="Fourth Option" value="<?php echo $saved_option34; ?>" required/></span>
																	</label>
																</div>
															</div>
														...
														<div class="row">
															<div class="pull-right">
																<form action="" method="POST">
																	...
																	<button class="btn btn-success disabled" name="FORM_NEXT" disabled="true">
																		Continue
																		<i class="ace-icon fa fa-arrow-right icon-on-right"></i>
																	</button>
																</form>
			...
			<script type="text/javascript">
				...
				function takeAudienceType() {
					...
					$.ajax({
						...
						type: 'POST',
						dataType: 'Json',
						data: {'json_identifier' : 'GET_TARGETED_AUDIENCE', 'min_age' : min_age, 'max_age' : max_age, 'gender' : gender},      
						...
						success: function( data, textStatus, jqXHR) {
							...
							if(!data.error){
								...
								// alert(tagert_audience);
								loadAudienceChart(tagert_audience, left_audience);
								// alert("inside");
							} else {
