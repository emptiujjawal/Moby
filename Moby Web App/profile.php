							...
							<div class="col-md-8 col-sm-8 col-xs-12">
								<form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand Name</label>
									...
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand Website Url</label>
									...
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand Contact</label>
									...
									<hr>
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand Location</label>
									...
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand City</label>
									...
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand State</label>
									...
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand Pincode</label>
									...
									<div class="form-group">
										<label class="col-xs-12 col-sm-3 col-sm-offset-1 control-label no-padding-right">Brand Landmark</label>

										<div class="col-xs-12 col-sm-7">
											<span class="block input-icon input-icon-right">
												<input type="text" class="width-100" value="<?php echo $store_detail->store_landmark; ?>" name="store_landmark"/>
												<i class="ace-icon fa fa-info-circle tooltip-primary" data-rel="tooltip" data-placement="right" title="Nearest landmark." ></i>
											</span>
										</div>
									</div>
									...
									<hr>
									<center>
										<button type="submit" name="UPDATE_SUB_WALLET" class="btn btn-primary" >Update Brand</button>
									</center>
								</form>
								<form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="col-md-4 col-sm-4 col-xs-12 well">
								...
								<div class="row">
									<form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 col-sm-offset-1  control-label no-padding-right">Update Brand Logo</label>
									...
									<form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label class="col-xs-12 col-sm-3 col-sm-offset-1  control-label no-padding-right">Update Brand Image</label>
